...
require (
	...
	github.com/project-flogo/edge-contrib/activity/mqtt v0.0.0-20190523234742-2d7b115b701a
	github.com/project-flogo/edge-contrib/trigger/mqtt v0.0.0-20190523234742-2d7b115b701a
